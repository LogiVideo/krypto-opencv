...
if(OPENCV_DOWNSTREAM_VERSION)
    set(OPENCV_PACKAGE_VERSION_STRING "${OPENCV_VERSION}-${OPENCV_DOWNSTREAM_VERSION}")
else()
    set(OPENCV_PACKAGE_VERSION_STRING "${OPENCV_VERSION}")
endif()
...
OpenCV makes it easy for businesses to utilize and modify the code.")
  ...
  set(CPACK_PACKAGE_VERSION "${OPENCV_PACKAGE_VERSION_STRING}")
...
if(CMAKE_BUILD_TYPE MATCHES "Debug")
    set(CPACK_PACKAGE_FILE_NAME "${CMAKE_PROJECT_NAME}-dbg_${OPENCV_PACKAGE_VERSION_STRING}_${CPACK_DEBIAN_PACKAGE_ARCHITECTURE}")
    set(CPACK_DEBIAN_PACKAGE_NAME "${CMAKE_PROJECT_NAME}-dbg")
else()
    set(CPACK_PACKAGE_FILE_NAME "${CMAKE_PROJECT_NAME}_${OPENCV_PACKAGE_VERSION_STRING}_${CPACK_DEBIAN_PACKAGE_ARCHITECTURE}")
    set(CPACK_DEBIAN_libs_FILE_NAME "${CMAKE_PROJECT_NAME}")
